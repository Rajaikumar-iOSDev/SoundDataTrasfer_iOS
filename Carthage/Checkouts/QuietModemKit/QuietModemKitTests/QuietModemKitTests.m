...
- (void)testFrameLoopback {
  ...
  QMFrameTransmitter *tx = [[QMFrameTransmitter alloc] initLoopbackWithConfig:txConf];
...
- (void)testLwipLoopbackUdp {
  ...
  QMNetworkInterface *intf = [[QMNetworkInterface alloc] initLoopbackWithConfig:conf];
